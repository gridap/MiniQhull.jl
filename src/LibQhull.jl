...
function qh_setcheck(qh, set, tname, id)
    ccall((:qh_setcheck, libqhull_r), Cvoid, (Ptr{qhT}, Ptr{setT}, Cstring, Cuint), qh, set, tname, id)
end
...
function qh_printallstatistics(qh, fp, string)
    ccall((:qh_printallstatistics, libqhull_r), Cvoid, (Ptr{qhT}, Ptr{Libc.FILE}, Cstring), qh, fp, string)
end

function qh_printstatistics(qh, fp, string)
    ccall((:qh_printstatistics, libqhull_r), Cvoid, (Ptr{qhT}, Ptr{Libc.FILE}, Cstring), qh, fp, string)
end
...
function qh_new_qhull(qh, dim, numpoints, points, ismalloc, qhull_cmd, outfile, errfile)
    ccall((:qh_new_qhull, libqhull_r), Cint, (Ptr{qhT}, Cint, Cint, Ptr{Cdouble}, Cuint, Cstring, Ptr{Libc.FILE}, Ptr{Libc.FILE}), qh, dim, numpoints, points, ismalloc, qhull_cmd, outfile, errfile)
end
...
function qh_init_A(qh, infile, outfile, errfile, argc, argv)
    ccall((:qh_init_A, libqhull_r), Cvoid, (Ptr{qhT}, Ptr{Libc.FILE}, Ptr{Libc.FILE}, Ptr{Libc.FILE}, Cint, Ptr{Cstring}), qh, infile, outfile, errfile, argc, argv)
end
