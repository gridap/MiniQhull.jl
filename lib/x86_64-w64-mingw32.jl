...
function Base.getproperty(x::Ptr{_SETJMP_FLOAT128}, f::Symbol)
    f === :Part && return Ptr{NTuple{2, Culonglong}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::_SETJMP_FLOAT128, f::Symbol)
    r = Ref{_SETJMP_FLOAT128}(x)
    ptr = Base.unsafe_convert(Ptr{_SETJMP_FLOAT128}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{_SETJMP_FLOAT128}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end

const SETJMP_FLOAT128 = _SETJMP_FLOAT128

const _JBTYPE = SETJMP_FLOAT128

const jmp_buf = NTuple{16, _JBTYPE}
...
function Base.getproperty(x::Ptr{facetT}, f::Symbol)
    ...
    f === :f && return Ptr{__JL_Ctag_4}(x + 32)
    f === :center && return Ptr{Ptr{Cdouble}}(x + 40)
    f === :previous && return Ptr{Ptr{facetT}}(x + 48)
    f === :next && return Ptr{Ptr{facetT}}(x + 56)
    f === :vertices && return Ptr{Ptr{setT}}(x + 64)
    f === :ridges && return Ptr{Ptr{setT}}(x + 72)
    f === :neighbors && return Ptr{Ptr{setT}}(x + 80)
    f === :outsideset && return Ptr{Ptr{setT}}(x + 88)
...
function Base.getproperty(x::Ptr{qhT}, f::Symbol)
    ...
    f === :feasible_string && return Ptr{Ptr{Cchar}}(x + 608)
    ...
    f === :errexit && return Ptr{jmp_buf}(x + 1936)
    f === :jmpXtra && return Ptr{NTuple{40, Cchar}}(x + 2192)
    f === :restartexit && return Ptr{jmp_buf}(x + 2240)
    f === :jmpXtra2 && return Ptr{NTuple{40, Cchar}}(x + 2496)
    f === :fin && return Ptr{Ptr{Libc.FILE}}(x + 2536)
    f === :fout && return Ptr{Ptr{Libc.FILE}}(x + 2544)
    f === :ferr && return Ptr{Ptr{Libc.FILE}}(x + 2552)
    f === :interior_point && return Ptr{Ptr{Cdouble}}(x + 2560)
    f === :normal_size && return Ptr{Cint}(x + 2568)
    f === :center_size && return Ptr{Cint}(x + 2572)
    f === :TEMPsize && return Ptr{Cint}(x + 2576)
    f === :facet_list && return Ptr{Ptr{facetT}}(x + 2584)
    f === :facet_tail && return Ptr{Ptr{facetT}}(x + 2592)
    f === :facet_next && return Ptr{Ptr{facetT}}(x + 2600)
    f === :newfacet_list && return Ptr{Ptr{facetT}}(x + 2608)
    f === :visible_list && return Ptr{Ptr{facetT}}(x + 2616)
    f === :num_visible && return Ptr{Cint}(x + 2624)
    f === :tracefacet_id && return Ptr{Cuint}(x + 2628)
    f === :tracefacet && return Ptr{Ptr{facetT}}(x + 2632)
    f === :traceridge_id && return Ptr{Cuint}(x + 2640)
    f === :traceridge && return Ptr{Ptr{ridgeT}}(x + 2648)
    f === :tracevertex_id && return Ptr{Cuint}(x + 2656)
    f === :tracevertex && return Ptr{Ptr{vertexT}}(x + 2664)
    f === :vertex_list && return Ptr{Ptr{vertexT}}(x + 2672)
    f === :vertex_tail && return Ptr{Ptr{vertexT}}(x + 2680)
    f === :newvertex_list && return Ptr{Ptr{vertexT}}(x + 2688)
    f === :num_facets && return Ptr{Cint}(x + 2696)
    f === :num_vertices && return Ptr{Cint}(x + 2700)
    f === :num_outside && return Ptr{Cint}(x + 2704)
    f === :num_good && return Ptr{Cint}(x + 2708)
    f === :facet_id && return Ptr{Cuint}(x + 2712)
    f === :ridge_id && return Ptr{Cuint}(x + 2716)
    f === :vertex_id && return Ptr{Cuint}(x + 2720)
    f === :first_newfacet && return Ptr{Cuint}(x + 2724)
    f === :hulltime && return Ptr{Culong}(x + 2728)
    f === :ALLOWrestart && return Ptr{Cuint}(x + 2732)
    f === :build_cnt && return Ptr{Cint}(x + 2736)
    f === :CENTERtype && return Ptr{qh_CENTER}(x + 2740)
    f === :furthest_id && return Ptr{Cint}(x + 2744)
    f === :last_errcode && return Ptr{Cint}(x + 2748)
    f === :GOODclosest && return Ptr{Ptr{facetT}}(x + 2752)
    f === :coplanar_apex && return Ptr{Ptr{Cdouble}}(x + 2760)
    f === :hasAreaVolume && return Ptr{Cuint}(x + 2768)
    f === :hasTriangulation && return Ptr{Cuint}(x + 2772)
    f === :isRenameVertex && return Ptr{Cuint}(x + 2776)
    f === :JOGGLEmax && return Ptr{Cdouble}(x + 2784)
    f === :maxoutdone && return Ptr{Cuint}(x + 2792)
    f === :max_outside && return Ptr{Cdouble}(x + 2800)
    f === :max_vertex && return Ptr{Cdouble}(x + 2808)
    f === :min_vertex && return Ptr{Cdouble}(x + 2816)
    f === :NEWfacets && return Ptr{Cuint}(x + 2824)
    f === :NEWtentative && return Ptr{Cuint}(x + 2828)
    f === :findbestnew && return Ptr{Cuint}(x + 2832)
    f === :findbest_notsharp && return Ptr{Cuint}(x + 2836)
    f === :NOerrexit && return Ptr{Cuint}(x + 2840)
    f === :PRINTcradius && return Ptr{Cdouble}(x + 2848)
    f === :PRINTradius && return Ptr{Cdouble}(x + 2856)
    f === :POSTmerging && return Ptr{Cuint}(x + 2864)
    f === :printoutvar && return Ptr{Cint}(x + 2868)
    f === :printoutnum && return Ptr{Cint}(x + 2872)
    f === :repart_facetid && return Ptr{Cuint}(x + 2876)
    f === :retry_addpoint && return Ptr{Cint}(x + 2880)
    f === :QHULLfinished && return Ptr{Cuint}(x + 2884)
    f === :totarea && return Ptr{Cdouble}(x + 2888)
    f === :totvol && return Ptr{Cdouble}(x + 2896)
    f === :visit_id && return Ptr{Cuint}(x + 2904)
    f === :vertex_visit && return Ptr{Cuint}(x + 2908)
    f === :WAScoplanar && return Ptr{Cuint}(x + 2912)
    f === :ZEROall_ok && return Ptr{Cuint}(x + 2916)
    f === :facet_mergeset && return Ptr{Ptr{setT}}(x + 2920)
    f === :degen_mergeset && return Ptr{Ptr{setT}}(x + 2928)
    f === :vertex_mergeset && return Ptr{Ptr{setT}}(x + 2936)
    f === :hash_table && return Ptr{Ptr{setT}}(x + 2944)
    f === :other_points && return Ptr{Ptr{setT}}(x + 2952)
    f === :del_vertices && return Ptr{Ptr{setT}}(x + 2960)
    f === :gm_matrix && return Ptr{Ptr{Cdouble}}(x + 2968)
    f === :gm_row && return Ptr{Ptr{Ptr{Cdouble}}}(x + 2976)
    f === :line && return Ptr{Ptr{Cchar}}(x + 2984)
    f === :maxline && return Ptr{Cint}(x + 2992)
    f === :half_space && return Ptr{Ptr{Cdouble}}(x + 3000)
    f === :temp_malloc && return Ptr{Ptr{Cdouble}}(x + 3008)
    f === :ERREXITcalled && return Ptr{Cuint}(x + 3016)
    f === :firstcentrum && return Ptr{Cuint}(x + 3020)
    f === :old_randomdist && return Ptr{Cuint}(x + 3024)
    f === :coplanarfacetset && return Ptr{Ptr{setT}}(x + 3032)
    f === :last_low && return Ptr{Cdouble}(x + 3040)
    f === :last_high && return Ptr{Cdouble}(x + 3048)
    f === :last_newhigh && return Ptr{Cdouble}(x + 3056)
    f === :lastcpu && return Ptr{Cdouble}(x + 3064)
    f === :lastfacets && return Ptr{Cint}(x + 3072)
    f === :lastmerges && return Ptr{Cint}(x + 3076)
    f === :lastplanes && return Ptr{Cint}(x + 3080)
    f === :lastdist && return Ptr{Cint}(x + 3084)
    f === :lastreport && return Ptr{Cuint}(x + 3088)
    f === :mergereport && return Ptr{Cint}(x + 3092)
    f === :old_tempstack && return Ptr{Ptr{setT}}(x + 3096)
    f === :ridgeoutnum && return Ptr{Cint}(x + 3104)
    f === :last_random && return Ptr{Cint}(x + 3108)
    f === :rbox_errexit && return Ptr{jmp_buf}(x + 3120)
    f === :jmpXtra3 && return Ptr{NTuple{40, Cchar}}(x + 3376)
    f === :rbox_isinteger && return Ptr{Cint}(x + 3416)
    f === :rbox_out_offset && return Ptr{Cdouble}(x + 3424)
    f === :cpp_object && return Ptr{Ptr{Cvoid}}(x + 3432)
    f === :cpp_other && return Ptr{Ptr{Cvoid}}(x + 3440)
    f === :cpp_user && return Ptr{Ptr{Cvoid}}(x + 3448)
    f === :qhmem && return Ptr{qhmemT}(x + 3456)
    f === :qhstat && return Ptr{qhstatT}(x + 3608)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{vertexT}, f::Symbol)
    ...
    f === :previous && return Ptr{Ptr{vertexT}}(x + 8)
    f === :point && return Ptr{Ptr{Cdouble}}(x + 16)
