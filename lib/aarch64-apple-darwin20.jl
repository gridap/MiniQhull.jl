...
function Base.getproperty(x::Ptr{facetT}, f::Symbol)
    ...
    f === :f && return Ptr{__JL_Ctag_6}(x + 32)
...
function Base.getproperty(x::Ptr{qhT}, f::Symbol)
    ...
    f === :jmpXtra && return Ptr{NTuple{40, Cchar}}(x + 2116)
    f === :restartexit && return Ptr{jmp_buf}(x + 2156)
    f === :jmpXtra2 && return Ptr{NTuple{40, Cchar}}(x + 2348)
    f === :fin && return Ptr{Ptr{Libc.FILE}}(x + 2392)
    f === :fout && return Ptr{Ptr{Libc.FILE}}(x + 2400)
    f === :ferr && return Ptr{Ptr{Libc.FILE}}(x + 2408)
    f === :interior_point && return Ptr{Ptr{Cdouble}}(x + 2416)
    f === :normal_size && return Ptr{Cint}(x + 2424)
    f === :center_size && return Ptr{Cint}(x + 2428)
    f === :TEMPsize && return Ptr{Cint}(x + 2432)
    f === :facet_list && return Ptr{Ptr{facetT}}(x + 2440)
    f === :facet_tail && return Ptr{Ptr{facetT}}(x + 2448)
    f === :facet_next && return Ptr{Ptr{facetT}}(x + 2456)
    f === :newfacet_list && return Ptr{Ptr{facetT}}(x + 2464)
    f === :visible_list && return Ptr{Ptr{facetT}}(x + 2472)
    f === :num_visible && return Ptr{Cint}(x + 2480)
    f === :tracefacet_id && return Ptr{Cuint}(x + 2484)
    f === :tracefacet && return Ptr{Ptr{facetT}}(x + 2488)
    f === :traceridge_id && return Ptr{Cuint}(x + 2496)
    f === :traceridge && return Ptr{Ptr{ridgeT}}(x + 2504)
    f === :tracevertex_id && return Ptr{Cuint}(x + 2512)
    f === :tracevertex && return Ptr{Ptr{vertexT}}(x + 2520)
    f === :vertex_list && return Ptr{Ptr{vertexT}}(x + 2528)
    f === :vertex_tail && return Ptr{Ptr{vertexT}}(x + 2536)
    f === :newvertex_list && return Ptr{Ptr{vertexT}}(x + 2544)
    f === :num_facets && return Ptr{Cint}(x + 2552)
    f === :num_vertices && return Ptr{Cint}(x + 2556)
    f === :num_outside && return Ptr{Cint}(x + 2560)
    f === :num_good && return Ptr{Cint}(x + 2564)
    f === :facet_id && return Ptr{Cuint}(x + 2568)
    f === :ridge_id && return Ptr{Cuint}(x + 2572)
    f === :vertex_id && return Ptr{Cuint}(x + 2576)
    f === :first_newfacet && return Ptr{Cuint}(x + 2580)
    f === :hulltime && return Ptr{Culong}(x + 2584)
    f === :ALLOWrestart && return Ptr{Cuint}(x + 2592)
    f === :build_cnt && return Ptr{Cint}(x + 2596)
    f === :CENTERtype && return Ptr{qh_CENTER}(x + 2600)
    f === :furthest_id && return Ptr{Cint}(x + 2604)
    f === :last_errcode && return Ptr{Cint}(x + 2608)
    f === :GOODclosest && return Ptr{Ptr{facetT}}(x + 2616)
    f === :coplanar_apex && return Ptr{Ptr{Cdouble}}(x + 2624)
    f === :hasAreaVolume && return Ptr{Cuint}(x + 2632)
    f === :hasTriangulation && return Ptr{Cuint}(x + 2636)
    f === :isRenameVertex && return Ptr{Cuint}(x + 2640)
    f === :JOGGLEmax && return Ptr{Cdouble}(x + 2648)
    f === :maxoutdone && return Ptr{Cuint}(x + 2656)
    f === :max_outside && return Ptr{Cdouble}(x + 2664)
    f === :max_vertex && return Ptr{Cdouble}(x + 2672)
    f === :min_vertex && return Ptr{Cdouble}(x + 2680)
    f === :NEWfacets && return Ptr{Cuint}(x + 2688)
    f === :NEWtentative && return Ptr{Cuint}(x + 2692)
    f === :findbestnew && return Ptr{Cuint}(x + 2696)
    f === :findbest_notsharp && return Ptr{Cuint}(x + 2700)
    f === :NOerrexit && return Ptr{Cuint}(x + 2704)
    f === :PRINTcradius && return Ptr{Cdouble}(x + 2712)
    f === :PRINTradius && return Ptr{Cdouble}(x + 2720)
    f === :POSTmerging && return Ptr{Cuint}(x + 2728)
    f === :printoutvar && return Ptr{Cint}(x + 2732)
    f === :printoutnum && return Ptr{Cint}(x + 2736)
    f === :repart_facetid && return Ptr{Cuint}(x + 2740)
    f === :retry_addpoint && return Ptr{Cint}(x + 2744)
    f === :QHULLfinished && return Ptr{Cuint}(x + 2748)
    f === :totarea && return Ptr{Cdouble}(x + 2752)
    f === :totvol && return Ptr{Cdouble}(x + 2760)
    f === :visit_id && return Ptr{Cuint}(x + 2768)
    f === :vertex_visit && return Ptr{Cuint}(x + 2772)
    f === :WAScoplanar && return Ptr{Cuint}(x + 2776)
    f === :ZEROall_ok && return Ptr{Cuint}(x + 2780)
    f === :facet_mergeset && return Ptr{Ptr{setT}}(x + 2784)
    f === :degen_mergeset && return Ptr{Ptr{setT}}(x + 2792)
    f === :vertex_mergeset && return Ptr{Ptr{setT}}(x + 2800)
    f === :hash_table && return Ptr{Ptr{setT}}(x + 2808)
    f === :other_points && return Ptr{Ptr{setT}}(x + 2816)
    f === :del_vertices && return Ptr{Ptr{setT}}(x + 2824)
    f === :gm_matrix && return Ptr{Ptr{Cdouble}}(x + 2832)
    f === :gm_row && return Ptr{Ptr{Ptr{Cdouble}}}(x + 2840)
    f === :line && return Ptr{Ptr{Cchar}}(x + 2848)
    f === :maxline && return Ptr{Cint}(x + 2856)
    f === :half_space && return Ptr{Ptr{Cdouble}}(x + 2864)
    f === :temp_malloc && return Ptr{Ptr{Cdouble}}(x + 2872)
    f === :ERREXITcalled && return Ptr{Cuint}(x + 2880)
    f === :firstcentrum && return Ptr{Cuint}(x + 2884)
    f === :old_randomdist && return Ptr{Cuint}(x + 2888)
    f === :coplanarfacetset && return Ptr{Ptr{setT}}(x + 2896)
    f === :last_low && return Ptr{Cdouble}(x + 2904)
    f === :last_high && return Ptr{Cdouble}(x + 2912)
    f === :last_newhigh && return Ptr{Cdouble}(x + 2920)
    f === :lastcpu && return Ptr{Cdouble}(x + 2928)
    f === :lastfacets && return Ptr{Cint}(x + 2936)
    f === :lastmerges && return Ptr{Cint}(x + 2940)
    f === :lastplanes && return Ptr{Cint}(x + 2944)
    f === :lastdist && return Ptr{Cint}(x + 2948)
    f === :lastreport && return Ptr{Cuint}(x + 2952)
    f === :mergereport && return Ptr{Cint}(x + 2956)
    f === :old_tempstack && return Ptr{Ptr{setT}}(x + 2960)
    f === :ridgeoutnum && return Ptr{Cint}(x + 2968)
    f === :last_random && return Ptr{Cint}(x + 2972)
    f === :rbox_errexit && return Ptr{jmp_buf}(x + 2976)
    f === :jmpXtra3 && return Ptr{NTuple{40, Cchar}}(x + 3168)
    f === :rbox_isinteger && return Ptr{Cint}(x + 3208)
    f === :rbox_out_offset && return Ptr{Cdouble}(x + 3216)
    f === :cpp_object && return Ptr{Ptr{Cvoid}}(x + 3224)
    f === :cpp_other && return Ptr{Ptr{Cvoid}}(x + 3232)
    f === :cpp_user && return Ptr{Ptr{Cvoid}}(x + 3240)
    f === :qhmem && return Ptr{qhmemT}(x + 3248)
    f === :qhstat && return Ptr{qhstatT}(x + 3400)
    return getfield(x, f)
end
