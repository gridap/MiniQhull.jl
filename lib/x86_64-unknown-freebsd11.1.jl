...
const jmp_buf = NTuple{1, _jmp_buf}
...
function Base.getproperty(x::Ptr{facetT}, f::Symbol)
    ...
    f === :f && return Ptr{__JL_Ctag_7}(x + 32)
...
function Base.getproperty(x::Ptr{qhT}, f::Symbol)
    ...
    f === :jmpXtra && return Ptr{NTuple{40, Cchar}}(x + 2024)
    f === :restartexit && return Ptr{jmp_buf}(x + 2064)
    f === :jmpXtra2 && return Ptr{NTuple{40, Cchar}}(x + 2160)
    f === :fin && return Ptr{Ptr{Libc.FILE}}(x + 2200)
    f === :fout && return Ptr{Ptr{Libc.FILE}}(x + 2208)
    f === :ferr && return Ptr{Ptr{Libc.FILE}}(x + 2216)
    f === :interior_point && return Ptr{Ptr{Cdouble}}(x + 2224)
    f === :normal_size && return Ptr{Cint}(x + 2232)
    f === :center_size && return Ptr{Cint}(x + 2236)
    f === :TEMPsize && return Ptr{Cint}(x + 2240)
    f === :facet_list && return Ptr{Ptr{facetT}}(x + 2248)
    f === :facet_tail && return Ptr{Ptr{facetT}}(x + 2256)
    f === :facet_next && return Ptr{Ptr{facetT}}(x + 2264)
    f === :newfacet_list && return Ptr{Ptr{facetT}}(x + 2272)
    f === :visible_list && return Ptr{Ptr{facetT}}(x + 2280)
    f === :num_visible && return Ptr{Cint}(x + 2288)
    f === :tracefacet_id && return Ptr{Cuint}(x + 2292)
    f === :tracefacet && return Ptr{Ptr{facetT}}(x + 2296)
    f === :traceridge_id && return Ptr{Cuint}(x + 2304)
    f === :traceridge && return Ptr{Ptr{ridgeT}}(x + 2312)
    f === :tracevertex_id && return Ptr{Cuint}(x + 2320)
    f === :tracevertex && return Ptr{Ptr{vertexT}}(x + 2328)
    f === :vertex_list && return Ptr{Ptr{vertexT}}(x + 2336)
    f === :vertex_tail && return Ptr{Ptr{vertexT}}(x + 2344)
    f === :newvertex_list && return Ptr{Ptr{vertexT}}(x + 2352)
    f === :num_facets && return Ptr{Cint}(x + 2360)
    f === :num_vertices && return Ptr{Cint}(x + 2364)
    f === :num_outside && return Ptr{Cint}(x + 2368)
    f === :num_good && return Ptr{Cint}(x + 2372)
    f === :facet_id && return Ptr{Cuint}(x + 2376)
    f === :ridge_id && return Ptr{Cuint}(x + 2380)
    f === :vertex_id && return Ptr{Cuint}(x + 2384)
    f === :first_newfacet && return Ptr{Cuint}(x + 2388)
    f === :hulltime && return Ptr{Culong}(x + 2392)
    f === :ALLOWrestart && return Ptr{Cuint}(x + 2400)
    f === :build_cnt && return Ptr{Cint}(x + 2404)
    f === :CENTERtype && return Ptr{qh_CENTER}(x + 2408)
    f === :furthest_id && return Ptr{Cint}(x + 2412)
    f === :last_errcode && return Ptr{Cint}(x + 2416)
    f === :GOODclosest && return Ptr{Ptr{facetT}}(x + 2424)
    f === :coplanar_apex && return Ptr{Ptr{Cdouble}}(x + 2432)
    f === :hasAreaVolume && return Ptr{Cuint}(x + 2440)
    f === :hasTriangulation && return Ptr{Cuint}(x + 2444)
    f === :isRenameVertex && return Ptr{Cuint}(x + 2448)
    f === :JOGGLEmax && return Ptr{Cdouble}(x + 2456)
    f === :maxoutdone && return Ptr{Cuint}(x + 2464)
    f === :max_outside && return Ptr{Cdouble}(x + 2472)
    f === :max_vertex && return Ptr{Cdouble}(x + 2480)
    f === :min_vertex && return Ptr{Cdouble}(x + 2488)
    f === :NEWfacets && return Ptr{Cuint}(x + 2496)
    f === :NEWtentative && return Ptr{Cuint}(x + 2500)
    f === :findbestnew && return Ptr{Cuint}(x + 2504)
    f === :findbest_notsharp && return Ptr{Cuint}(x + 2508)
    f === :NOerrexit && return Ptr{Cuint}(x + 2512)
    f === :PRINTcradius && return Ptr{Cdouble}(x + 2520)
    f === :PRINTradius && return Ptr{Cdouble}(x + 2528)
    f === :POSTmerging && return Ptr{Cuint}(x + 2536)
    f === :printoutvar && return Ptr{Cint}(x + 2540)
    f === :printoutnum && return Ptr{Cint}(x + 2544)
    f === :repart_facetid && return Ptr{Cuint}(x + 2548)
    f === :retry_addpoint && return Ptr{Cint}(x + 2552)
    f === :QHULLfinished && return Ptr{Cuint}(x + 2556)
    f === :totarea && return Ptr{Cdouble}(x + 2560)
    f === :totvol && return Ptr{Cdouble}(x + 2568)
    f === :visit_id && return Ptr{Cuint}(x + 2576)
    f === :vertex_visit && return Ptr{Cuint}(x + 2580)
    f === :WAScoplanar && return Ptr{Cuint}(x + 2584)
    f === :ZEROall_ok && return Ptr{Cuint}(x + 2588)
    f === :facet_mergeset && return Ptr{Ptr{setT}}(x + 2592)
    f === :degen_mergeset && return Ptr{Ptr{setT}}(x + 2600)
    f === :vertex_mergeset && return Ptr{Ptr{setT}}(x + 2608)
    f === :hash_table && return Ptr{Ptr{setT}}(x + 2616)
    f === :other_points && return Ptr{Ptr{setT}}(x + 2624)
    f === :del_vertices && return Ptr{Ptr{setT}}(x + 2632)
    f === :gm_matrix && return Ptr{Ptr{Cdouble}}(x + 2640)
    f === :gm_row && return Ptr{Ptr{Ptr{Cdouble}}}(x + 2648)
    f === :line && return Ptr{Ptr{Cchar}}(x + 2656)
    f === :maxline && return Ptr{Cint}(x + 2664)
    f === :half_space && return Ptr{Ptr{Cdouble}}(x + 2672)
    f === :temp_malloc && return Ptr{Ptr{Cdouble}}(x + 2680)
    f === :ERREXITcalled && return Ptr{Cuint}(x + 2688)
    f === :firstcentrum && return Ptr{Cuint}(x + 2692)
    f === :old_randomdist && return Ptr{Cuint}(x + 2696)
    f === :coplanarfacetset && return Ptr{Ptr{setT}}(x + 2704)
    f === :last_low && return Ptr{Cdouble}(x + 2712)
    f === :last_high && return Ptr{Cdouble}(x + 2720)
    f === :last_newhigh && return Ptr{Cdouble}(x + 2728)
    f === :lastcpu && return Ptr{Cdouble}(x + 2736)
    f === :lastfacets && return Ptr{Cint}(x + 2744)
    f === :lastmerges && return Ptr{Cint}(x + 2748)
    f === :lastplanes && return Ptr{Cint}(x + 2752)
    f === :lastdist && return Ptr{Cint}(x + 2756)
    f === :lastreport && return Ptr{Cuint}(x + 2760)
    f === :mergereport && return Ptr{Cint}(x + 2764)
    f === :old_tempstack && return Ptr{Ptr{setT}}(x + 2768)
    f === :ridgeoutnum && return Ptr{Cint}(x + 2776)
    f === :last_random && return Ptr{Cint}(x + 2780)
    f === :rbox_errexit && return Ptr{jmp_buf}(x + 2784)
    f === :jmpXtra3 && return Ptr{NTuple{40, Cchar}}(x + 2880)
    f === :rbox_isinteger && return Ptr{Cint}(x + 2920)
    f === :rbox_out_offset && return Ptr{Cdouble}(x + 2928)
    f === :cpp_object && return Ptr{Ptr{Cvoid}}(x + 2936)
    f === :cpp_other && return Ptr{Ptr{Cvoid}}(x + 2944)
    f === :cpp_user && return Ptr{Ptr{Cvoid}}(x + 2952)
    f === :qhmem && return Ptr{qhmemT}(x + 2960)
    f === :qhstat && return Ptr{qhstatT}(x + 3112)
    return getfield(x, f)
end
