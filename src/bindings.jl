...
function delaunay_init_and_compute(qh::Ptr{Cvoid}, dim::Int32, numpoints::Int32, points::Vector{Float64}, numcells::Ref{Int32})
    @check_if_loaded
...
function delaunay_fill_cells(qh::Ptr{Cvoid}, dim::Int32, numcells::Int32, cells::Vector{Int32})
    @check_if_loaded
