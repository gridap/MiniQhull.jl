const __jmp_buf = NTuple{22, Culong}
...
function Base.getproperty(x::Ptr{qhT}, f::Symbol)
    ...
    f === :jmpXtra && return Ptr{NTuple{40, Cchar}}(x + 2240)
    f === :restartexit && return Ptr{jmp_buf}(x + 2280)
    f === :jmpXtra2 && return Ptr{NTuple{40, Cchar}}(x + 2592)
    f === :fin && return Ptr{Ptr{Libc.FILE}}(x + 2632)
    f === :fout && return Ptr{Ptr{Libc.FILE}}(x + 2640)
    f === :ferr && return Ptr{Ptr{Libc.FILE}}(x + 2648)
    f === :interior_point && return Ptr{Ptr{Cdouble}}(x + 2656)
    f === :normal_size && return Ptr{Cint}(x + 2664)
    f === :center_size && return Ptr{Cint}(x + 2668)
    f === :TEMPsize && return Ptr{Cint}(x + 2672)
    f === :facet_list && return Ptr{Ptr{facetT}}(x + 2680)
    f === :facet_tail && return Ptr{Ptr{facetT}}(x + 2688)
    f === :facet_next && return Ptr{Ptr{facetT}}(x + 2696)
    f === :newfacet_list && return Ptr{Ptr{facetT}}(x + 2704)
    f === :visible_list && return Ptr{Ptr{facetT}}(x + 2712)
    f === :num_visible && return Ptr{Cint}(x + 2720)
    f === :tracefacet_id && return Ptr{Cuint}(x + 2724)
    f === :tracefacet && return Ptr{Ptr{facetT}}(x + 2728)
    f === :traceridge_id && return Ptr{Cuint}(x + 2736)
    f === :traceridge && return Ptr{Ptr{ridgeT}}(x + 2744)
    f === :tracevertex_id && return Ptr{Cuint}(x + 2752)
    f === :tracevertex && return Ptr{Ptr{vertexT}}(x + 2760)
    f === :vertex_list && return Ptr{Ptr{vertexT}}(x + 2768)
    f === :vertex_tail && return Ptr{Ptr{vertexT}}(x + 2776)
    f === :newvertex_list && return Ptr{Ptr{vertexT}}(x + 2784)
    f === :num_facets && return Ptr{Cint}(x + 2792)
    f === :num_vertices && return Ptr{Cint}(x + 2796)
    f === :num_outside && return Ptr{Cint}(x + 2800)
    f === :num_good && return Ptr{Cint}(x + 2804)
    f === :facet_id && return Ptr{Cuint}(x + 2808)
    f === :ridge_id && return Ptr{Cuint}(x + 2812)
    f === :vertex_id && return Ptr{Cuint}(x + 2816)
    f === :first_newfacet && return Ptr{Cuint}(x + 2820)
    f === :hulltime && return Ptr{Culong}(x + 2824)
    f === :ALLOWrestart && return Ptr{Cuint}(x + 2832)
    f === :build_cnt && return Ptr{Cint}(x + 2836)
    f === :CENTERtype && return Ptr{qh_CENTER}(x + 2840)
    f === :furthest_id && return Ptr{Cint}(x + 2844)
    f === :last_errcode && return Ptr{Cint}(x + 2848)
    f === :GOODclosest && return Ptr{Ptr{facetT}}(x + 2856)
    f === :coplanar_apex && return Ptr{Ptr{Cdouble}}(x + 2864)
    f === :hasAreaVolume && return Ptr{Cuint}(x + 2872)
    f === :hasTriangulation && return Ptr{Cuint}(x + 2876)
    f === :isRenameVertex && return Ptr{Cuint}(x + 2880)
    f === :JOGGLEmax && return Ptr{Cdouble}(x + 2888)
    f === :maxoutdone && return Ptr{Cuint}(x + 2896)
    f === :max_outside && return Ptr{Cdouble}(x + 2904)
    f === :max_vertex && return Ptr{Cdouble}(x + 2912)
    f === :min_vertex && return Ptr{Cdouble}(x + 2920)
    f === :NEWfacets && return Ptr{Cuint}(x + 2928)
    f === :NEWtentative && return Ptr{Cuint}(x + 2932)
    f === :findbestnew && return Ptr{Cuint}(x + 2936)
    f === :findbest_notsharp && return Ptr{Cuint}(x + 2940)
    f === :NOerrexit && return Ptr{Cuint}(x + 2944)
    f === :PRINTcradius && return Ptr{Cdouble}(x + 2952)
    f === :PRINTradius && return Ptr{Cdouble}(x + 2960)
    f === :POSTmerging && return Ptr{Cuint}(x + 2968)
    f === :printoutvar && return Ptr{Cint}(x + 2972)
    f === :printoutnum && return Ptr{Cint}(x + 2976)
    f === :repart_facetid && return Ptr{Cuint}(x + 2980)
    f === :retry_addpoint && return Ptr{Cint}(x + 2984)
    f === :QHULLfinished && return Ptr{Cuint}(x + 2988)
    f === :totarea && return Ptr{Cdouble}(x + 2992)
    f === :totvol && return Ptr{Cdouble}(x + 3000)
    f === :visit_id && return Ptr{Cuint}(x + 3008)
    f === :vertex_visit && return Ptr{Cuint}(x + 3012)
    f === :WAScoplanar && return Ptr{Cuint}(x + 3016)
    f === :ZEROall_ok && return Ptr{Cuint}(x + 3020)
    f === :facet_mergeset && return Ptr{Ptr{setT}}(x + 3024)
    f === :degen_mergeset && return Ptr{Ptr{setT}}(x + 3032)
    f === :vertex_mergeset && return Ptr{Ptr{setT}}(x + 3040)
    f === :hash_table && return Ptr{Ptr{setT}}(x + 3048)
    f === :other_points && return Ptr{Ptr{setT}}(x + 3056)
    f === :del_vertices && return Ptr{Ptr{setT}}(x + 3064)
    f === :gm_matrix && return Ptr{Ptr{Cdouble}}(x + 3072)
    f === :gm_row && return Ptr{Ptr{Ptr{Cdouble}}}(x + 3080)
    f === :line && return Ptr{Ptr{Cchar}}(x + 3088)
    f === :maxline && return Ptr{Cint}(x + 3096)
    f === :half_space && return Ptr{Ptr{Cdouble}}(x + 3104)
    f === :temp_malloc && return Ptr{Ptr{Cdouble}}(x + 3112)
    f === :ERREXITcalled && return Ptr{Cuint}(x + 3120)
    f === :firstcentrum && return Ptr{Cuint}(x + 3124)
    f === :old_randomdist && return Ptr{Cuint}(x + 3128)
    f === :coplanarfacetset && return Ptr{Ptr{setT}}(x + 3136)
    f === :last_low && return Ptr{Cdouble}(x + 3144)
    f === :last_high && return Ptr{Cdouble}(x + 3152)
    f === :last_newhigh && return Ptr{Cdouble}(x + 3160)
    f === :lastcpu && return Ptr{Cdouble}(x + 3168)
    f === :lastfacets && return Ptr{Cint}(x + 3176)
    f === :lastmerges && return Ptr{Cint}(x + 3180)
    f === :lastplanes && return Ptr{Cint}(x + 3184)
    f === :lastdist && return Ptr{Cint}(x + 3188)
    f === :lastreport && return Ptr{Cuint}(x + 3192)
    f === :mergereport && return Ptr{Cint}(x + 3196)
    f === :old_tempstack && return Ptr{Ptr{setT}}(x + 3200)
    f === :ridgeoutnum && return Ptr{Cint}(x + 3208)
    f === :last_random && return Ptr{Cint}(x + 3212)
    f === :rbox_errexit && return Ptr{jmp_buf}(x + 3216)
    f === :jmpXtra3 && return Ptr{NTuple{40, Cchar}}(x + 3528)
    f === :rbox_isinteger && return Ptr{Cint}(x + 3568)
    f === :rbox_out_offset && return Ptr{Cdouble}(x + 3576)
    f === :cpp_object && return Ptr{Ptr{Cvoid}}(x + 3584)
    f === :cpp_other && return Ptr{Ptr{Cvoid}}(x + 3592)
    f === :cpp_user && return Ptr{Ptr{Cvoid}}(x + 3600)
    f === :qhmem && return Ptr{qhmemT}(x + 3608)
