const __jmp_buf = NTuple{8, Culong}

struct __jmp_buf_tag
    __jb::__jmp_buf
    __fl::Culong
    __ss::NTuple{16, Culong}
end
...
function Base.getproperty(x::Ptr{qhT}, f::Symbol)
    ...
    f === :errexit && return Ptr{jmp_buf}(x + 1928)
    f === :jmpXtra && return Ptr{NTuple{40, Cchar}}(x + 2128)
    f === :restartexit && return Ptr{jmp_buf}(x + 2168)
    f === :jmpXtra2 && return Ptr{NTuple{40, Cchar}}(x + 2368)
    f === :fin && return Ptr{Ptr{Libc.FILE}}(x + 2408)
    f === :fout && return Ptr{Ptr{Libc.FILE}}(x + 2416)
    f === :ferr && return Ptr{Ptr{Libc.FILE}}(x + 2424)
    f === :interior_point && return Ptr{Ptr{Cdouble}}(x + 2432)
    f === :normal_size && return Ptr{Cint}(x + 2440)
    f === :center_size && return Ptr{Cint}(x + 2444)
    f === :TEMPsize && return Ptr{Cint}(x + 2448)
    f === :facet_list && return Ptr{Ptr{facetT}}(x + 2456)
    f === :facet_tail && return Ptr{Ptr{facetT}}(x + 2464)
    f === :facet_next && return Ptr{Ptr{facetT}}(x + 2472)
    f === :newfacet_list && return Ptr{Ptr{facetT}}(x + 2480)
    f === :visible_list && return Ptr{Ptr{facetT}}(x + 2488)
    f === :num_visible && return Ptr{Cint}(x + 2496)
    f === :tracefacet_id && return Ptr{Cuint}(x + 2500)
    f === :tracefacet && return Ptr{Ptr{facetT}}(x + 2504)
    f === :traceridge_id && return Ptr{Cuint}(x + 2512)
    f === :traceridge && return Ptr{Ptr{ridgeT}}(x + 2520)
    f === :tracevertex_id && return Ptr{Cuint}(x + 2528)
    f === :tracevertex && return Ptr{Ptr{vertexT}}(x + 2536)
    f === :vertex_list && return Ptr{Ptr{vertexT}}(x + 2544)
    f === :vertex_tail && return Ptr{Ptr{vertexT}}(x + 2552)
    f === :newvertex_list && return Ptr{Ptr{vertexT}}(x + 2560)
    f === :num_facets && return Ptr{Cint}(x + 2568)
    f === :num_vertices && return Ptr{Cint}(x + 2572)
    f === :num_outside && return Ptr{Cint}(x + 2576)
    f === :num_good && return Ptr{Cint}(x + 2580)
    f === :facet_id && return Ptr{Cuint}(x + 2584)
    f === :ridge_id && return Ptr{Cuint}(x + 2588)
    f === :vertex_id && return Ptr{Cuint}(x + 2592)
    f === :first_newfacet && return Ptr{Cuint}(x + 2596)
    f === :hulltime && return Ptr{Culong}(x + 2600)
    f === :ALLOWrestart && return Ptr{Cuint}(x + 2608)
    f === :build_cnt && return Ptr{Cint}(x + 2612)
    f === :CENTERtype && return Ptr{qh_CENTER}(x + 2616)
    f === :furthest_id && return Ptr{Cint}(x + 2620)
    f === :last_errcode && return Ptr{Cint}(x + 2624)
    f === :GOODclosest && return Ptr{Ptr{facetT}}(x + 2632)
    f === :coplanar_apex && return Ptr{Ptr{Cdouble}}(x + 2640)
    f === :hasAreaVolume && return Ptr{Cuint}(x + 2648)
    f === :hasTriangulation && return Ptr{Cuint}(x + 2652)
    f === :isRenameVertex && return Ptr{Cuint}(x + 2656)
    f === :JOGGLEmax && return Ptr{Cdouble}(x + 2664)
    f === :maxoutdone && return Ptr{Cuint}(x + 2672)
    f === :max_outside && return Ptr{Cdouble}(x + 2680)
    f === :max_vertex && return Ptr{Cdouble}(x + 2688)
    f === :min_vertex && return Ptr{Cdouble}(x + 2696)
    f === :NEWfacets && return Ptr{Cuint}(x + 2704)
    f === :NEWtentative && return Ptr{Cuint}(x + 2708)
    f === :findbestnew && return Ptr{Cuint}(x + 2712)
    f === :findbest_notsharp && return Ptr{Cuint}(x + 2716)
    f === :NOerrexit && return Ptr{Cuint}(x + 2720)
    f === :PRINTcradius && return Ptr{Cdouble}(x + 2728)
    f === :PRINTradius && return Ptr{Cdouble}(x + 2736)
    f === :POSTmerging && return Ptr{Cuint}(x + 2744)
    f === :printoutvar && return Ptr{Cint}(x + 2748)
    f === :printoutnum && return Ptr{Cint}(x + 2752)
    f === :repart_facetid && return Ptr{Cuint}(x + 2756)
    f === :retry_addpoint && return Ptr{Cint}(x + 2760)
    f === :QHULLfinished && return Ptr{Cuint}(x + 2764)
    f === :totarea && return Ptr{Cdouble}(x + 2768)
    f === :totvol && return Ptr{Cdouble}(x + 2776)
    f === :visit_id && return Ptr{Cuint}(x + 2784)
    f === :vertex_visit && return Ptr{Cuint}(x + 2788)
    f === :WAScoplanar && return Ptr{Cuint}(x + 2792)
    f === :ZEROall_ok && return Ptr{Cuint}(x + 2796)
    f === :facet_mergeset && return Ptr{Ptr{setT}}(x + 2800)
    f === :degen_mergeset && return Ptr{Ptr{setT}}(x + 2808)
    f === :vertex_mergeset && return Ptr{Ptr{setT}}(x + 2816)
    f === :hash_table && return Ptr{Ptr{setT}}(x + 2824)
    f === :other_points && return Ptr{Ptr{setT}}(x + 2832)
    f === :del_vertices && return Ptr{Ptr{setT}}(x + 2840)
    f === :gm_matrix && return Ptr{Ptr{Cdouble}}(x + 2848)
    f === :gm_row && return Ptr{Ptr{Ptr{Cdouble}}}(x + 2856)
    f === :line && return Ptr{Ptr{Cchar}}(x + 2864)
    f === :maxline && return Ptr{Cint}(x + 2872)
    f === :half_space && return Ptr{Ptr{Cdouble}}(x + 2880)
    f === :temp_malloc && return Ptr{Ptr{Cdouble}}(x + 2888)
    f === :ERREXITcalled && return Ptr{Cuint}(x + 2896)
    f === :firstcentrum && return Ptr{Cuint}(x + 2900)
    f === :old_randomdist && return Ptr{Cuint}(x + 2904)
    f === :coplanarfacetset && return Ptr{Ptr{setT}}(x + 2912)
    f === :last_low && return Ptr{Cdouble}(x + 2920)
    f === :last_high && return Ptr{Cdouble}(x + 2928)
    f === :last_newhigh && return Ptr{Cdouble}(x + 2936)
    f === :lastcpu && return Ptr{Cdouble}(x + 2944)
    f === :lastfacets && return Ptr{Cint}(x + 2952)
    f === :lastmerges && return Ptr{Cint}(x + 2956)
    f === :lastplanes && return Ptr{Cint}(x + 2960)
    f === :lastdist && return Ptr{Cint}(x + 2964)
    f === :lastreport && return Ptr{Cuint}(x + 2968)
    f === :mergereport && return Ptr{Cint}(x + 2972)
    f === :old_tempstack && return Ptr{Ptr{setT}}(x + 2976)
    f === :ridgeoutnum && return Ptr{Cint}(x + 2984)
    f === :last_random && return Ptr{Cint}(x + 2988)
    f === :rbox_errexit && return Ptr{jmp_buf}(x + 2992)
    f === :jmpXtra3 && return Ptr{NTuple{40, Cchar}}(x + 3192)
    f === :rbox_isinteger && return Ptr{Cint}(x + 3232)
    f === :rbox_out_offset && return Ptr{Cdouble}(x + 3240)
    f === :cpp_object && return Ptr{Ptr{Cvoid}}(x + 3248)
    f === :cpp_other && return Ptr{Ptr{Cvoid}}(x + 3256)
    f === :cpp_user && return Ptr{Ptr{Cvoid}}(x + 3264)
    f === :qhmem && return Ptr{qhmemT}(x + 3272)
    f === :qhstat && return Ptr{qhstatT}(x + 3424)
    return getfield(x, f)
end
