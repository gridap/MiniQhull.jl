const __jmp_buf = NTuple{6, Culong}

struct __jmp_buf_tag
    __jb::__jmp_buf
    __fl::Culong
    __ss::NTuple{32, Culong}
end
...
function Base.getproperty(x::Ptr{facetT}, f::Symbol)
    ...
    f === :f && return Ptr{__JL_Ctag_4}(x + 28)
    f === :center && return Ptr{Ptr{Cdouble}}(x + 36)
    f === :previous && return Ptr{Ptr{facetT}}(x + 40)
    f === :next && return Ptr{Ptr{facetT}}(x + 44)
    f === :vertices && return Ptr{Ptr{setT}}(x + 48)
    f === :ridges && return Ptr{Ptr{setT}}(x + 52)
    f === :neighbors && return Ptr{Ptr{setT}}(x + 56)
    f === :outsideset && return Ptr{Ptr{setT}}(x + 60)
...
function Base.getproperty(x::Ptr{qhT}, f::Symbol)
    ...
    f === :KEEPminArea && return Ptr{Cdouble}(x + 148)
    f === :MAXcoplanar && return Ptr{Cdouble}(x + 156)
    f === :MAXwide && return Ptr{Cint}(x + 164)
    f === :MERGEexact && return Ptr{Cuint}(x + 168)
    f === :MERGEindependent && return Ptr{Cuint}(x + 172)
    f === :MERGING && return Ptr{Cuint}(x + 176)
    f === :premerge_centrum && return Ptr{Cdouble}(x + 180)
    f === :postmerge_centrum && return Ptr{Cdouble}(x + 188)
    f === :MERGEpinched && return Ptr{Cuint}(x + 196)
    f === :MERGEvertices && return Ptr{Cuint}(x + 200)
    f === :MINvisible && return Ptr{Cdouble}(x + 204)
    f === :NOnarrow && return Ptr{Cuint}(x + 212)
    f === :NOnearinside && return Ptr{Cuint}(x + 216)
    f === :NOpremerge && return Ptr{Cuint}(x + 220)
    f === :ONLYgood && return Ptr{Cuint}(x + 224)
    f === :ONLYmax && return Ptr{Cuint}(x + 228)
    f === :PICKfurthest && return Ptr{Cuint}(x + 232)
    f === :POSTmerge && return Ptr{Cuint}(x + 236)
    f === :PREmerge && return Ptr{Cuint}(x + 240)
    f === :PRINTcentrums && return Ptr{Cuint}(x + 244)
    f === :PRINTcoplanar && return Ptr{Cuint}(x + 248)
    f === :PRINTdim && return Ptr{Cint}(x + 252)
    f === :PRINTdots && return Ptr{Cuint}(x + 256)
    f === :PRINTgood && return Ptr{Cuint}(x + 260)
    f === :PRINTinner && return Ptr{Cuint}(x + 264)
    f === :PRINTneighbors && return Ptr{Cuint}(x + 268)
    f === :PRINTnoplanes && return Ptr{Cuint}(x + 272)
    f === :PRINToptions1st && return Ptr{Cuint}(x + 276)
    f === :PRINTouter && return Ptr{Cuint}(x + 280)
    f === :PRINTprecision && return Ptr{Cuint}(x + 284)
    f === :PRINTout && return Ptr{NTuple{29, qh_PRINT}}(x + 288)
    f === :PRINTridges && return Ptr{Cuint}(x + 404)
    f === :PRINTspheres && return Ptr{Cuint}(x + 408)
    f === :PRINTstatistics && return Ptr{Cuint}(x + 412)
    f === :PRINTsummary && return Ptr{Cuint}(x + 416)
    f === :PRINTtransparent && return Ptr{Cuint}(x + 420)
    f === :PROJECTdelaunay && return Ptr{Cuint}(x + 424)
    f === :PROJECTinput && return Ptr{Cint}(x + 428)
    f === :RANDOMdist && return Ptr{Cuint}(x + 432)
    f === :RANDOMfactor && return Ptr{Cdouble}(x + 436)
    f === :RANDOMa && return Ptr{Cdouble}(x + 444)
    f === :RANDOMb && return Ptr{Cdouble}(x + 452)
    f === :RANDOMoutside && return Ptr{Cuint}(x + 460)
    f === :REPORTfreq && return Ptr{Cint}(x + 464)
    f === :REPORTfreq2 && return Ptr{Cint}(x + 468)
    f === :RERUN && return Ptr{Cint}(x + 472)
    f === :ROTATErandom && return Ptr{Cint}(x + 476)
    f === :SCALEinput && return Ptr{Cuint}(x + 480)
    f === :SCALElast && return Ptr{Cuint}(x + 484)
    f === :SETroundoff && return Ptr{Cuint}(x + 488)
    f === :SKIPcheckmax && return Ptr{Cuint}(x + 492)
    f === :SKIPconvex && return Ptr{Cuint}(x + 496)
    f === :SPLITthresholds && return Ptr{Cuint}(x + 500)
    f === :STOPadd && return Ptr{Cint}(x + 504)
    f === :STOPcone && return Ptr{Cint}(x + 508)
    f === :STOPpoint && return Ptr{Cint}(x + 512)
    f === :TESTpoints && return Ptr{Cint}(x + 516)
    f === :TESTvneighbors && return Ptr{Cuint}(x + 520)
    f === :TRACElevel && return Ptr{Cint}(x + 524)
    f === :TRACElastrun && return Ptr{Cint}(x + 528)
    f === :TRACEpoint && return Ptr{Cint}(x + 532)
    f === :TRACEdist && return Ptr{Cdouble}(x + 536)
    f === :TRACEmerge && return Ptr{Cint}(x + 544)
    f === :TRIangulate && return Ptr{Cuint}(x + 548)
    f === :TRInormals && return Ptr{Cuint}(x + 552)
    f === :UPPERdelaunay && return Ptr{Cuint}(x + 556)
    f === :USEstdout && return Ptr{Cuint}(x + 560)
    f === :VERIFYoutput && return Ptr{Cuint}(x + 564)
    f === :VIRTUALmemory && return Ptr{Cuint}(x + 568)
    f === :VORONOI && return Ptr{Cuint}(x + 572)
    f === :AREAfactor && return Ptr{Cdouble}(x + 576)
    f === :DOcheckmax && return Ptr{Cuint}(x + 584)
    f === :feasible_string && return Ptr{Ptr{Cchar}}(x + 588)
    f === :feasible_point && return Ptr{Ptr{Cdouble}}(x + 592)
    f === :GETarea && return Ptr{Cuint}(x + 596)
    f === :KEEPnearinside && return Ptr{Cuint}(x + 600)
    f === :hull_dim && return Ptr{Cint}(x + 604)
    f === :input_dim && return Ptr{Cint}(x + 608)
    f === :num_points && return Ptr{Cint}(x + 612)
    f === :first_point && return Ptr{Ptr{Cdouble}}(x + 616)
    f === :POINTSmalloc && return Ptr{Cuint}(x + 620)
    f === :input_points && return Ptr{Ptr{Cdouble}}(x + 624)
    f === :input_malloc && return Ptr{Cuint}(x + 628)
    f === :qhull_command && return Ptr{NTuple{256, Cchar}}(x + 632)
    f === :qhull_commandsiz2 && return Ptr{Cint}(x + 888)
    f === :rbox_command && return Ptr{NTuple{256, Cchar}}(x + 892)
    f === :qhull_options && return Ptr{NTuple{512, Cchar}}(x + 1148)
    f === :qhull_optionlen && return Ptr{Cint}(x + 1660)
    f === :qhull_optionsiz && return Ptr{Cint}(x + 1664)
    f === :qhull_optionsiz2 && return Ptr{Cint}(x + 1668)
    f === :run_id && return Ptr{Cint}(x + 1672)
    f === :VERTEXneighbors && return Ptr{Cuint}(x + 1676)
    f === :ZEROcentrum && return Ptr{Cuint}(x + 1680)
    f === :upper_threshold && return Ptr{Ptr{Cdouble}}(x + 1684)
    f === :lower_threshold && return Ptr{Ptr{Cdouble}}(x + 1688)
    f === :upper_bound && return Ptr{Ptr{Cdouble}}(x + 1692)
    f === :lower_bound && return Ptr{Ptr{Cdouble}}(x + 1696)
    f === :ANGLEround && return Ptr{Cdouble}(x + 1700)
    f === :centrum_radius && return Ptr{Cdouble}(x + 1708)
    f === :cos_max && return Ptr{Cdouble}(x + 1716)
    f === :DISTround && return Ptr{Cdouble}(x + 1724)
    f === :MAXabs_coord && return Ptr{Cdouble}(x + 1732)
    f === :MAXlastcoord && return Ptr{Cdouble}(x + 1740)
    f === :MAXoutside && return Ptr{Cdouble}(x + 1748)
    f === :MAXsumcoord && return Ptr{Cdouble}(x + 1756)
    f === :MAXwidth && return Ptr{Cdouble}(x + 1764)
    f === :MINdenom_1 && return Ptr{Cdouble}(x + 1772)
    f === :MINdenom && return Ptr{Cdouble}(x + 1780)
    f === :MINdenom_1_2 && return Ptr{Cdouble}(x + 1788)
    f === :MINdenom_2 && return Ptr{Cdouble}(x + 1796)
    f === :MINlastcoord && return Ptr{Cdouble}(x + 1804)
    f === :NEARzero && return Ptr{Ptr{Cdouble}}(x + 1812)
    f === :NEARinside && return Ptr{Cdouble}(x + 1816)
    f === :ONEmerge && return Ptr{Cdouble}(x + 1824)
    f === :outside_err && return Ptr{Cdouble}(x + 1832)
    f === :WIDEfacet && return Ptr{Cdouble}(x + 1840)
    f === :NARROWhull && return Ptr{Cuint}(x + 1848)
    f === :qhull && return Ptr{NTuple{6, Cchar}}(x + 1852)
    f === :errexit && return Ptr{jmp_buf}(x + 1860)
    f === :jmpXtra && return Ptr{NTuple{40, Cchar}}(x + 2016)
    f === :restartexit && return Ptr{jmp_buf}(x + 2056)
    f === :jmpXtra2 && return Ptr{NTuple{40, Cchar}}(x + 2212)
    f === :fin && return Ptr{Ptr{Libc.FILE}}(x + 2252)
    f === :fout && return Ptr{Ptr{Libc.FILE}}(x + 2256)
    f === :ferr && return Ptr{Ptr{Libc.FILE}}(x + 2260)
    f === :interior_point && return Ptr{Ptr{Cdouble}}(x + 2264)
    f === :normal_size && return Ptr{Cint}(x + 2268)
    f === :center_size && return Ptr{Cint}(x + 2272)
    f === :TEMPsize && return Ptr{Cint}(x + 2276)
    f === :facet_list && return Ptr{Ptr{facetT}}(x + 2280)
    f === :facet_tail && return Ptr{Ptr{facetT}}(x + 2284)
    f === :facet_next && return Ptr{Ptr{facetT}}(x + 2288)
    f === :newfacet_list && return Ptr{Ptr{facetT}}(x + 2292)
    f === :visible_list && return Ptr{Ptr{facetT}}(x + 2296)
    f === :num_visible && return Ptr{Cint}(x + 2300)
    f === :tracefacet_id && return Ptr{Cuint}(x + 2304)
    f === :tracefacet && return Ptr{Ptr{facetT}}(x + 2308)
    f === :traceridge_id && return Ptr{Cuint}(x + 2312)
    f === :traceridge && return Ptr{Ptr{ridgeT}}(x + 2316)
    f === :tracevertex_id && return Ptr{Cuint}(x + 2320)
    f === :tracevertex && return Ptr{Ptr{vertexT}}(x + 2324)
    f === :vertex_list && return Ptr{Ptr{vertexT}}(x + 2328)
    f === :vertex_tail && return Ptr{Ptr{vertexT}}(x + 2332)
    f === :newvertex_list && return Ptr{Ptr{vertexT}}(x + 2336)
    f === :num_facets && return Ptr{Cint}(x + 2340)
    f === :num_vertices && return Ptr{Cint}(x + 2344)
    f === :num_outside && return Ptr{Cint}(x + 2348)
    f === :num_good && return Ptr{Cint}(x + 2352)
    f === :facet_id && return Ptr{Cuint}(x + 2356)
    f === :ridge_id && return Ptr{Cuint}(x + 2360)
    f === :vertex_id && return Ptr{Cuint}(x + 2364)
    f === :first_newfacet && return Ptr{Cuint}(x + 2368)
    f === :hulltime && return Ptr{Culong}(x + 2372)
    f === :ALLOWrestart && return Ptr{Cuint}(x + 2376)
    f === :build_cnt && return Ptr{Cint}(x + 2380)
    f === :CENTERtype && return Ptr{qh_CENTER}(x + 2384)
    f === :furthest_id && return Ptr{Cint}(x + 2388)
    f === :last_errcode && return Ptr{Cint}(x + 2392)
    f === :GOODclosest && return Ptr{Ptr{facetT}}(x + 2396)
    f === :coplanar_apex && return Ptr{Ptr{Cdouble}}(x + 2400)
    f === :hasAreaVolume && return Ptr{Cuint}(x + 2404)
    f === :hasTriangulation && return Ptr{Cuint}(x + 2408)
    f === :isRenameVertex && return Ptr{Cuint}(x + 2412)
    f === :JOGGLEmax && return Ptr{Cdouble}(x + 2416)
    f === :maxoutdone && return Ptr{Cuint}(x + 2424)
    f === :max_outside && return Ptr{Cdouble}(x + 2428)
    f === :max_vertex && return Ptr{Cdouble}(x + 2436)
    f === :min_vertex && return Ptr{Cdouble}(x + 2444)
    f === :NEWfacets && return Ptr{Cuint}(x + 2452)
    f === :NEWtentative && return Ptr{Cuint}(x + 2456)
    f === :findbestnew && return Ptr{Cuint}(x + 2460)
    f === :findbest_notsharp && return Ptr{Cuint}(x + 2464)
    f === :NOerrexit && return Ptr{Cuint}(x + 2468)
    f === :PRINTcradius && return Ptr{Cdouble}(x + 2472)
    f === :PRINTradius && return Ptr{Cdouble}(x + 2480)
    f === :POSTmerging && return Ptr{Cuint}(x + 2488)
    f === :printoutvar && return Ptr{Cint}(x + 2492)
    f === :printoutnum && return Ptr{Cint}(x + 2496)
    f === :repart_facetid && return Ptr{Cuint}(x + 2500)
    f === :retry_addpoint && return Ptr{Cint}(x + 2504)
    f === :QHULLfinished && return Ptr{Cuint}(x + 2508)
    f === :totarea && return Ptr{Cdouble}(x + 2512)
    f === :totvol && return Ptr{Cdouble}(x + 2520)
    f === :visit_id && return Ptr{Cuint}(x + 2528)
    f === :vertex_visit && return Ptr{Cuint}(x + 2532)
    f === :WAScoplanar && return Ptr{Cuint}(x + 2536)
    f === :ZEROall_ok && return Ptr{Cuint}(x + 2540)
    f === :facet_mergeset && return Ptr{Ptr{setT}}(x + 2544)
    f === :degen_mergeset && return Ptr{Ptr{setT}}(x + 2548)
    f === :vertex_mergeset && return Ptr{Ptr{setT}}(x + 2552)
    f === :hash_table && return Ptr{Ptr{setT}}(x + 2556)
    f === :other_points && return Ptr{Ptr{setT}}(x + 2560)
    f === :del_vertices && return Ptr{Ptr{setT}}(x + 2564)
    f === :gm_matrix && return Ptr{Ptr{Cdouble}}(x + 2568)
    f === :gm_row && return Ptr{Ptr{Ptr{Cdouble}}}(x + 2572)
    f === :line && return Ptr{Ptr{Cchar}}(x + 2576)
    f === :maxline && return Ptr{Cint}(x + 2580)
    f === :half_space && return Ptr{Ptr{Cdouble}}(x + 2584)
    f === :temp_malloc && return Ptr{Ptr{Cdouble}}(x + 2588)
    f === :ERREXITcalled && return Ptr{Cuint}(x + 2592)
    f === :firstcentrum && return Ptr{Cuint}(x + 2596)
    f === :old_randomdist && return Ptr{Cuint}(x + 2600)
    f === :coplanarfacetset && return Ptr{Ptr{setT}}(x + 2604)
    f === :last_low && return Ptr{Cdouble}(x + 2608)
    f === :last_high && return Ptr{Cdouble}(x + 2616)
    f === :last_newhigh && return Ptr{Cdouble}(x + 2624)
    f === :lastcpu && return Ptr{Cdouble}(x + 2632)
    f === :lastfacets && return Ptr{Cint}(x + 2640)
    f === :lastmerges && return Ptr{Cint}(x + 2644)
    f === :lastplanes && return Ptr{Cint}(x + 2648)
    f === :lastdist && return Ptr{Cint}(x + 2652)
    f === :lastreport && return Ptr{Cuint}(x + 2656)
    f === :mergereport && return Ptr{Cint}(x + 2660)
    f === :old_tempstack && return Ptr{Ptr{setT}}(x + 2664)
    f === :ridgeoutnum && return Ptr{Cint}(x + 2668)
    f === :last_random && return Ptr{Cint}(x + 2672)
    f === :rbox_errexit && return Ptr{jmp_buf}(x + 2676)
    f === :jmpXtra3 && return Ptr{NTuple{40, Cchar}}(x + 2832)
    f === :rbox_isinteger && return Ptr{Cint}(x + 2872)
    f === :rbox_out_offset && return Ptr{Cdouble}(x + 2876)
    f === :cpp_object && return Ptr{Ptr{Cvoid}}(x + 2884)
    f === :cpp_other && return Ptr{Ptr{Cvoid}}(x + 2888)
    f === :cpp_user && return Ptr{Ptr{Cvoid}}(x + 2892)
    f === :qhmem && return Ptr{qhmemT}(x + 2896)
    f === :qhstat && return Ptr{qhstatT}(x + 3012)
    return getfield(x, f)
end
