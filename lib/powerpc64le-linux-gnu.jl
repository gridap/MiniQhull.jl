const __jmp_buf = NTuple{64, Clong}
...
function Base.getproperty(x::Ptr{qhT}, f::Symbol)
    ...
    f === :jmpXtra && return Ptr{NTuple{40, Cchar}}(x + 2592)
    f === :restartexit && return Ptr{jmp_buf}(x + 2640)
    f === :jmpXtra2 && return Ptr{NTuple{40, Cchar}}(x + 3296)
    f === :fin && return Ptr{Ptr{Libc.FILE}}(x + 3336)
    f === :fout && return Ptr{Ptr{Libc.FILE}}(x + 3344)
    f === :ferr && return Ptr{Ptr{Libc.FILE}}(x + 3352)
    f === :interior_point && return Ptr{Ptr{Cdouble}}(x + 3360)
    f === :normal_size && return Ptr{Cint}(x + 3368)
    f === :center_size && return Ptr{Cint}(x + 3372)
    f === :TEMPsize && return Ptr{Cint}(x + 3376)
    f === :facet_list && return Ptr{Ptr{facetT}}(x + 3384)
    f === :facet_tail && return Ptr{Ptr{facetT}}(x + 3392)
    f === :facet_next && return Ptr{Ptr{facetT}}(x + 3400)
    f === :newfacet_list && return Ptr{Ptr{facetT}}(x + 3408)
    f === :visible_list && return Ptr{Ptr{facetT}}(x + 3416)
    f === :num_visible && return Ptr{Cint}(x + 3424)
    f === :tracefacet_id && return Ptr{Cuint}(x + 3428)
    f === :tracefacet && return Ptr{Ptr{facetT}}(x + 3432)
    f === :traceridge_id && return Ptr{Cuint}(x + 3440)
    f === :traceridge && return Ptr{Ptr{ridgeT}}(x + 3448)
    f === :tracevertex_id && return Ptr{Cuint}(x + 3456)
    f === :tracevertex && return Ptr{Ptr{vertexT}}(x + 3464)
    f === :vertex_list && return Ptr{Ptr{vertexT}}(x + 3472)
    f === :vertex_tail && return Ptr{Ptr{vertexT}}(x + 3480)
    f === :newvertex_list && return Ptr{Ptr{vertexT}}(x + 3488)
    f === :num_facets && return Ptr{Cint}(x + 3496)
    f === :num_vertices && return Ptr{Cint}(x + 3500)
    f === :num_outside && return Ptr{Cint}(x + 3504)
    f === :num_good && return Ptr{Cint}(x + 3508)
    f === :facet_id && return Ptr{Cuint}(x + 3512)
    f === :ridge_id && return Ptr{Cuint}(x + 3516)
    f === :vertex_id && return Ptr{Cuint}(x + 3520)
    f === :first_newfacet && return Ptr{Cuint}(x + 3524)
    f === :hulltime && return Ptr{Culong}(x + 3528)
    f === :ALLOWrestart && return Ptr{Cuint}(x + 3536)
    f === :build_cnt && return Ptr{Cint}(x + 3540)
    f === :CENTERtype && return Ptr{qh_CENTER}(x + 3544)
    f === :furthest_id && return Ptr{Cint}(x + 3548)
    f === :last_errcode && return Ptr{Cint}(x + 3552)
    f === :GOODclosest && return Ptr{Ptr{facetT}}(x + 3560)
    f === :coplanar_apex && return Ptr{Ptr{Cdouble}}(x + 3568)
    f === :hasAreaVolume && return Ptr{Cuint}(x + 3576)
    f === :hasTriangulation && return Ptr{Cuint}(x + 3580)
    f === :isRenameVertex && return Ptr{Cuint}(x + 3584)
    f === :JOGGLEmax && return Ptr{Cdouble}(x + 3592)
    f === :maxoutdone && return Ptr{Cuint}(x + 3600)
    f === :max_outside && return Ptr{Cdouble}(x + 3608)
    f === :max_vertex && return Ptr{Cdouble}(x + 3616)
    f === :min_vertex && return Ptr{Cdouble}(x + 3624)
    f === :NEWfacets && return Ptr{Cuint}(x + 3632)
    f === :NEWtentative && return Ptr{Cuint}(x + 3636)
    f === :findbestnew && return Ptr{Cuint}(x + 3640)
    f === :findbest_notsharp && return Ptr{Cuint}(x + 3644)
    f === :NOerrexit && return Ptr{Cuint}(x + 3648)
    f === :PRINTcradius && return Ptr{Cdouble}(x + 3656)
    f === :PRINTradius && return Ptr{Cdouble}(x + 3664)
    f === :POSTmerging && return Ptr{Cuint}(x + 3672)
    f === :printoutvar && return Ptr{Cint}(x + 3676)
    f === :printoutnum && return Ptr{Cint}(x + 3680)
    f === :repart_facetid && return Ptr{Cuint}(x + 3684)
    f === :retry_addpoint && return Ptr{Cint}(x + 3688)
    f === :QHULLfinished && return Ptr{Cuint}(x + 3692)
    f === :totarea && return Ptr{Cdouble}(x + 3696)
    f === :totvol && return Ptr{Cdouble}(x + 3704)
    f === :visit_id && return Ptr{Cuint}(x + 3712)
    f === :vertex_visit && return Ptr{Cuint}(x + 3716)
    f === :WAScoplanar && return Ptr{Cuint}(x + 3720)
    f === :ZEROall_ok && return Ptr{Cuint}(x + 3724)
    f === :facet_mergeset && return Ptr{Ptr{setT}}(x + 3728)
    f === :degen_mergeset && return Ptr{Ptr{setT}}(x + 3736)
    f === :vertex_mergeset && return Ptr{Ptr{setT}}(x + 3744)
    f === :hash_table && return Ptr{Ptr{setT}}(x + 3752)
    f === :other_points && return Ptr{Ptr{setT}}(x + 3760)
    f === :del_vertices && return Ptr{Ptr{setT}}(x + 3768)
    f === :gm_matrix && return Ptr{Ptr{Cdouble}}(x + 3776)
    f === :gm_row && return Ptr{Ptr{Ptr{Cdouble}}}(x + 3784)
    f === :line && return Ptr{Ptr{Cchar}}(x + 3792)
    f === :maxline && return Ptr{Cint}(x + 3800)
    f === :half_space && return Ptr{Ptr{Cdouble}}(x + 3808)
    f === :temp_malloc && return Ptr{Ptr{Cdouble}}(x + 3816)
    f === :ERREXITcalled && return Ptr{Cuint}(x + 3824)
    f === :firstcentrum && return Ptr{Cuint}(x + 3828)
    f === :old_randomdist && return Ptr{Cuint}(x + 3832)
    f === :coplanarfacetset && return Ptr{Ptr{setT}}(x + 3840)
    f === :last_low && return Ptr{Cdouble}(x + 3848)
    f === :last_high && return Ptr{Cdouble}(x + 3856)
    f === :last_newhigh && return Ptr{Cdouble}(x + 3864)
    f === :lastcpu && return Ptr{Cdouble}(x + 3872)
    f === :lastfacets && return Ptr{Cint}(x + 3880)
    f === :lastmerges && return Ptr{Cint}(x + 3884)
    f === :lastplanes && return Ptr{Cint}(x + 3888)
    f === :lastdist && return Ptr{Cint}(x + 3892)
    f === :lastreport && return Ptr{Cuint}(x + 3896)
    f === :mergereport && return Ptr{Cint}(x + 3900)
    f === :old_tempstack && return Ptr{Ptr{setT}}(x + 3904)
    f === :ridgeoutnum && return Ptr{Cint}(x + 3912)
    f === :last_random && return Ptr{Cint}(x + 3916)
    f === :rbox_errexit && return Ptr{jmp_buf}(x + 3920)
    f === :jmpXtra3 && return Ptr{NTuple{40, Cchar}}(x + 4576)
    f === :rbox_isinteger && return Ptr{Cint}(x + 4616)
    f === :rbox_out_offset && return Ptr{Cdouble}(x + 4624)
    f === :cpp_object && return Ptr{Ptr{Cvoid}}(x + 4632)
    f === :cpp_other && return Ptr{Ptr{Cvoid}}(x + 4640)
    f === :cpp_user && return Ptr{Ptr{Cvoid}}(x + 4648)
    f === :qhmem && return Ptr{qhmemT}(x + 4656)
    f === :qhstat && return Ptr{qhstatT}(x + 4808)
    return getfield(x, f)
end
