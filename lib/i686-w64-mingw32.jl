...
function Base.getproperty(x::Ptr{qhT}, f::Symbol)
    ...
    f === :errexit && return Ptr{jmp_buf}(x + 1876)
    f === :jmpXtra && return Ptr{NTuple{40, Cchar}}(x + 1940)
    f === :restartexit && return Ptr{jmp_buf}(x + 1980)
    f === :jmpXtra2 && return Ptr{NTuple{40, Cchar}}(x + 2044)
    f === :fin && return Ptr{Ptr{Libc.FILE}}(x + 2084)
    f === :fout && return Ptr{Ptr{Libc.FILE}}(x + 2088)
    f === :ferr && return Ptr{Ptr{Libc.FILE}}(x + 2092)
    f === :interior_point && return Ptr{Ptr{Cdouble}}(x + 2096)
    f === :normal_size && return Ptr{Cint}(x + 2100)
    f === :center_size && return Ptr{Cint}(x + 2104)
    f === :TEMPsize && return Ptr{Cint}(x + 2108)
    f === :facet_list && return Ptr{Ptr{facetT}}(x + 2112)
    f === :facet_tail && return Ptr{Ptr{facetT}}(x + 2116)
    f === :facet_next && return Ptr{Ptr{facetT}}(x + 2120)
    f === :newfacet_list && return Ptr{Ptr{facetT}}(x + 2124)
    f === :visible_list && return Ptr{Ptr{facetT}}(x + 2128)
    f === :num_visible && return Ptr{Cint}(x + 2132)
    f === :tracefacet_id && return Ptr{Cuint}(x + 2136)
    f === :tracefacet && return Ptr{Ptr{facetT}}(x + 2140)
    f === :traceridge_id && return Ptr{Cuint}(x + 2144)
    f === :traceridge && return Ptr{Ptr{ridgeT}}(x + 2148)
    f === :tracevertex_id && return Ptr{Cuint}(x + 2152)
    f === :tracevertex && return Ptr{Ptr{vertexT}}(x + 2156)
    f === :vertex_list && return Ptr{Ptr{vertexT}}(x + 2160)
    f === :vertex_tail && return Ptr{Ptr{vertexT}}(x + 2164)
    f === :newvertex_list && return Ptr{Ptr{vertexT}}(x + 2168)
    f === :num_facets && return Ptr{Cint}(x + 2172)
    f === :num_vertices && return Ptr{Cint}(x + 2176)
    f === :num_outside && return Ptr{Cint}(x + 2180)
    f === :num_good && return Ptr{Cint}(x + 2184)
    f === :facet_id && return Ptr{Cuint}(x + 2188)
    f === :ridge_id && return Ptr{Cuint}(x + 2192)
    f === :vertex_id && return Ptr{Cuint}(x + 2196)
    f === :first_newfacet && return Ptr{Cuint}(x + 2200)
    f === :hulltime && return Ptr{Culong}(x + 2204)
    f === :ALLOWrestart && return Ptr{Cuint}(x + 2208)
    f === :build_cnt && return Ptr{Cint}(x + 2212)
    f === :CENTERtype && return Ptr{qh_CENTER}(x + 2216)
    f === :furthest_id && return Ptr{Cint}(x + 2220)
    f === :last_errcode && return Ptr{Cint}(x + 2224)
    f === :GOODclosest && return Ptr{Ptr{facetT}}(x + 2228)
    f === :coplanar_apex && return Ptr{Ptr{Cdouble}}(x + 2232)
    f === :hasAreaVolume && return Ptr{Cuint}(x + 2236)
    f === :hasTriangulation && return Ptr{Cuint}(x + 2240)
    f === :isRenameVertex && return Ptr{Cuint}(x + 2244)
    f === :JOGGLEmax && return Ptr{Cdouble}(x + 2248)
    f === :maxoutdone && return Ptr{Cuint}(x + 2256)
    f === :max_outside && return Ptr{Cdouble}(x + 2264)
    f === :max_vertex && return Ptr{Cdouble}(x + 2272)
    f === :min_vertex && return Ptr{Cdouble}(x + 2280)
    f === :NEWfacets && return Ptr{Cuint}(x + 2288)
    f === :NEWtentative && return Ptr{Cuint}(x + 2292)
    f === :findbestnew && return Ptr{Cuint}(x + 2296)
    f === :findbest_notsharp && return Ptr{Cuint}(x + 2300)
    f === :NOerrexit && return Ptr{Cuint}(x + 2304)
    f === :PRINTcradius && return Ptr{Cdouble}(x + 2312)
    f === :PRINTradius && return Ptr{Cdouble}(x + 2320)
    f === :POSTmerging && return Ptr{Cuint}(x + 2328)
    f === :printoutvar && return Ptr{Cint}(x + 2332)
    f === :printoutnum && return Ptr{Cint}(x + 2336)
    f === :repart_facetid && return Ptr{Cuint}(x + 2340)
    f === :retry_addpoint && return Ptr{Cint}(x + 2344)
    f === :QHULLfinished && return Ptr{Cuint}(x + 2348)
    f === :totarea && return Ptr{Cdouble}(x + 2352)
    f === :totvol && return Ptr{Cdouble}(x + 2360)
    f === :visit_id && return Ptr{Cuint}(x + 2368)
    f === :vertex_visit && return Ptr{Cuint}(x + 2372)
    f === :WAScoplanar && return Ptr{Cuint}(x + 2376)
    f === :ZEROall_ok && return Ptr{Cuint}(x + 2380)
    f === :facet_mergeset && return Ptr{Ptr{setT}}(x + 2384)
    f === :degen_mergeset && return Ptr{Ptr{setT}}(x + 2388)
    f === :vertex_mergeset && return Ptr{Ptr{setT}}(x + 2392)
    f === :hash_table && return Ptr{Ptr{setT}}(x + 2396)
    f === :other_points && return Ptr{Ptr{setT}}(x + 2400)
    f === :del_vertices && return Ptr{Ptr{setT}}(x + 2404)
    f === :gm_matrix && return Ptr{Ptr{Cdouble}}(x + 2408)
    f === :gm_row && return Ptr{Ptr{Ptr{Cdouble}}}(x + 2412)
    f === :line && return Ptr{Ptr{Cchar}}(x + 2416)
    f === :maxline && return Ptr{Cint}(x + 2420)
    f === :half_space && return Ptr{Ptr{Cdouble}}(x + 2424)
    f === :temp_malloc && return Ptr{Ptr{Cdouble}}(x + 2428)
    f === :ERREXITcalled && return Ptr{Cuint}(x + 2432)
    f === :firstcentrum && return Ptr{Cuint}(x + 2436)
    f === :old_randomdist && return Ptr{Cuint}(x + 2440)
    f === :coplanarfacetset && return Ptr{Ptr{setT}}(x + 2444)
    f === :last_low && return Ptr{Cdouble}(x + 2448)
    f === :last_high && return Ptr{Cdouble}(x + 2456)
    f === :last_newhigh && return Ptr{Cdouble}(x + 2464)
    f === :lastcpu && return Ptr{Cdouble}(x + 2472)
    f === :lastfacets && return Ptr{Cint}(x + 2480)
    f === :lastmerges && return Ptr{Cint}(x + 2484)
    f === :lastplanes && return Ptr{Cint}(x + 2488)
    f === :lastdist && return Ptr{Cint}(x + 2492)
    f === :lastreport && return Ptr{Cuint}(x + 2496)
    f === :mergereport && return Ptr{Cint}(x + 2500)
    f === :old_tempstack && return Ptr{Ptr{setT}}(x + 2504)
    f === :ridgeoutnum && return Ptr{Cint}(x + 2508)
    f === :last_random && return Ptr{Cint}(x + 2512)
    f === :rbox_errexit && return Ptr{jmp_buf}(x + 2516)
    f === :jmpXtra3 && return Ptr{NTuple{40, Cchar}}(x + 2580)
    f === :rbox_isinteger && return Ptr{Cint}(x + 2620)
    f === :rbox_out_offset && return Ptr{Cdouble}(x + 2624)
    f === :cpp_object && return Ptr{Ptr{Cvoid}}(x + 2632)
    f === :cpp_other && return Ptr{Ptr{Cvoid}}(x + 2636)
    f === :cpp_user && return Ptr{Ptr{Cvoid}}(x + 2640)
    f === :qhmem && return Ptr{qhmemT}(x + 2644)
    f === :qhstat && return Ptr{qhstatT}(x + 2760)
    return getfield(x, f)
end
